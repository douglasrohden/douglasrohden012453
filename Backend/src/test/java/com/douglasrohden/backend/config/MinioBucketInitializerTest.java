...
@DisplayName("MinioBucketInitializer component tests")
class MinioBucketInitializerTest {

    @Test
    @DisplayName("loads MinioBucketInitializer via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.config.MinioBucketInitializer"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for MinioBucketInitializer
