...
@DisplayName("MinioConfig component tests")
class MinioConfigTest {

    @Test
    @DisplayName("loads MinioConfig via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.config.MinioConfig"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for MinioConfig
