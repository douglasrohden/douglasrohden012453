...
@DisplayName("OpenApiConfig component tests")
class OpenApiConfigTest {

    @Test
    @DisplayName("loads OpenApiConfig via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.config.OpenApiConfig"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for OpenApiConfig
