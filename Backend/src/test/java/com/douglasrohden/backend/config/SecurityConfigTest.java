...
@DisplayName("SecurityConfig component tests")
class SecurityConfigTest {

    @Test
    @DisplayName("loads SecurityConfig via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.config.SecurityConfig"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for SecurityConfig
