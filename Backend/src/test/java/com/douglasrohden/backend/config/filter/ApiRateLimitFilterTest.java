...
@DisplayName("ApiRateLimitFilter component tests")
class ApiRateLimitFilterTest {

    @Test
    @DisplayName("loads ApiRateLimitFilter via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.config.filter.ApiRateLimitFilter"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for ApiRateLimitFilter
