...
@DisplayName("AlbumImageController controller tests")
class AlbumImageControllerTest {

    @Test
    @DisplayName("loads AlbumImageController via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.controller.AlbumImageController"));
    }
