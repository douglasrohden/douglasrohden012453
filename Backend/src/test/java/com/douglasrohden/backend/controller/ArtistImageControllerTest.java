...
@DisplayName("ArtistImageController controller tests")
class ArtistImageControllerTest {

    @Test
    @DisplayName("loads ArtistImageController via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.controller.ArtistImageController"));
    }
