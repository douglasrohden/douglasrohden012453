...
class AuthenticationControllerTest {
    ...
    @Test
    @DisplayName("loads AuthenticationController via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.controller.AuthenticationController"));
    }
