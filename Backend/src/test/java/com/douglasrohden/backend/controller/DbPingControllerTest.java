...
@DisplayName("DbPingController component tests")
class DbPingControllerTest {

    @Test
    @DisplayName("loads DbPingController via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.controller.DbPingController"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for DbPingController
