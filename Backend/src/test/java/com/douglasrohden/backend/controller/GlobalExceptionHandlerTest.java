...
@DisplayName("GlobalExceptionHandler controller tests")
class GlobalExceptionHandlerTest {

    @Test
    @DisplayName("loads GlobalExceptionHandler via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.controller.GlobalExceptionHandler"));
    }
