...
@DisplayName("RegionalController controller tests")
class RegionalControllerTest {

    @Test
    @DisplayName("loads RegionalController via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.controller.RegionalController"));
    }
