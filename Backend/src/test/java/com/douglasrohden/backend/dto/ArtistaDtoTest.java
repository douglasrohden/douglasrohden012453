...
@DisplayName("ArtistaDto component tests")
class ArtistaDtoTest {

    @Test
    @DisplayName("loads ArtistaDto via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.dto.ArtistaDto"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for ArtistaDto
