...
@DisplayName("ArtistaRequest component tests")
class ArtistaRequestTest {

    @Test
    @DisplayName("loads ArtistaRequest via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.dto.ArtistaRequest"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for ArtistaRequest
