...
@DisplayName("LoginRequest component tests")
class LoginRequestTest {

    @Test
    @DisplayName("loads LoginRequest via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.dto.LoginRequest"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for LoginRequest
