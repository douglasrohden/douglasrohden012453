...
@DisplayName("LoginResponse component tests")
class LoginResponseTest {

    @Test
    @DisplayName("loads LoginResponse via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.dto.LoginResponse"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for LoginResponse
