...
@DisplayName("AlbumImage component tests")
class AlbumImageTest {

    @Test
    @DisplayName("loads AlbumImage via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.model.AlbumImage"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for AlbumImage
