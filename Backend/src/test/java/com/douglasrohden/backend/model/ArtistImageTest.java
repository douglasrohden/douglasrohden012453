...
@DisplayName("ArtistImage component tests")
class ArtistImageTest {

    @Test
    @DisplayName("loads ArtistImage via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.model.ArtistImage"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for ArtistImage
