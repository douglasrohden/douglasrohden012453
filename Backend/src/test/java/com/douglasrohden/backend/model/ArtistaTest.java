...
@DisplayName("Artista component tests")
class ArtistaTest {

    @Test
    @DisplayName("loads Artista via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.model.Artista"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for Artista
