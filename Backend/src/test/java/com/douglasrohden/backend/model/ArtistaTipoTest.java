...
@DisplayName("ArtistaTipo component tests")
class ArtistaTipoTest {

    @Test
    @DisplayName("loads ArtistaTipo via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.model.ArtistaTipo"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for ArtistaTipo
