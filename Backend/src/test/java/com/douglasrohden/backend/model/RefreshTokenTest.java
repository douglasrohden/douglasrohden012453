...
@DisplayName("RefreshToken component tests")
class RefreshTokenTest {

    @Test
    @DisplayName("loads RefreshToken via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.model.RefreshToken"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for RefreshToken
