...
class ArtistImageRepositoryTest {
    ...
    @Test
    @DisplayName("loads ArtistImageRepository via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.repository.ArtistImageRepository"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: persist a Artist Image entity and assert it can be read back
