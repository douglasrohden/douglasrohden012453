...
@DisplayName("RequestLoggingFilter component tests")
class RequestLoggingFilterTest {

    @Test
    @DisplayName("loads RequestLoggingFilter via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.security.RequestLoggingFilter"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: add real scenario for RequestLoggingFilter
