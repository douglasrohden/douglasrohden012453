...
class ArtistaServiceTest {
    ...
    @Test
    @DisplayName("loads ArtistaService via reflection")
    void loadsClass() {
        assertDoesNotThrow(() -> Class.forName("com.douglasrohden.backend.service.ArtistaService"));
    }
    ...
    class Scenarios {
        ...
        void happyPath() {
            // TODO: wire ArtistaService with mocks and assert behaviour
