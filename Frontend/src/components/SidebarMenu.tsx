            ...
            >
                <Sidebar aria-label="Main Sidebar Navigation" className="w-full">
                    <div className="mb-5 flex items-center justify-between pl-2.5 pr-2">
                        ...
                        <button
                            onClick={onClose}
                            className="ml-auto flex items-center justify-center rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:hidden"
                        >
