...
describe('CreateAlbumForm', () => {
  ...
  it('renders default structure', () => {
    const { container } = render(<CreateAlbumForm />);
  ...
  it.skip('handles a basic user interaction', async () => {
    ...
    // TODO: replace this with a real interaction/assertion for CreateAlbumForm
    await user.keyboard(' ');
  ...
  it.skip('responds to prop changes', () => {
    ...
    const { rerender } = render(<CreateAlbumForm /* exampleProp="initial" */ />);
    rerender(<CreateAlbumForm /* exampleProp="updated" */ />);
  ...
  it.skip('invokes callback props', async () => {
    ...
    const user = userEvent.setup();
    render(<CreateAlbumForm /* onAction={onAction} */ />);
