...
describe('CreateArtistForm', () => {
  ...
  it.skip('handles a basic user interaction', async () => {
    ...
    // TODO: replace this with a real interaction/assertion for CreateArtistForm
    await user.keyboard(' ');
  ...
  it.skip('responds to prop changes', () => {
    ...
    const { rerender } = render(<CreateArtistForm /* exampleProp="initial" */ />);
    rerender(<CreateArtistForm /* exampleProp="updated" */ />);
  ...
  it.skip('invokes callback props', async () => {
    ...
    const user = userEvent.setup();
    render(<CreateArtistForm /* onAction={onAction} */ />);
