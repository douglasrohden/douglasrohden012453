...
describe('PublicRoute', () => {
  ...
  it.skip('handles a basic user interaction', async () => {
    ...
    render(<PublicRoute />);
    // TODO: replace this with a real interaction/assertion for PublicRoute
    await user.keyboard(' ');
  ...
  it.skip('responds to prop changes', () => {
    ...
    const { rerender } = render(<PublicRoute /* exampleProp="initial" */ />);
    rerender(<PublicRoute /* exampleProp="updated" */ />);
  ...
  it.skip('invokes callback props', async () => {
    ...
    const user = userEvent.setup();
    render(<PublicRoute /* onAction={onAction} */ />);
