...
describe('CardGrid', () => {
  ...
  it.skip('handles a basic user interaction', async () => {
    ...
    render(<CardGrid />);
    // TODO: replace this with a real interaction/assertion for CardGrid
    await user.keyboard(' ');
  ...
  it.skip('responds to prop changes', () => {
    ...
    const { rerender } = render(<CardGrid /* exampleProp="initial" */ />);
    rerender(<CardGrid /* exampleProp="updated" */ />);
  ...
  it.skip('invokes callback props', async () => {
    ...
    const user = userEvent.setup();
    render(<CardGrid /* onAction={onAction} */ />);
