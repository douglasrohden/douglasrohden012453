...
describe('PageLayout', () => {
  ...
  it.skip('handles a basic user interaction', async () => {
    ...
    render(<PageLayout />);
    // TODO: replace this with a real interaction/assertion for PageLayout
    await user.keyboard(' ');
  ...
  it.skip('responds to prop changes', () => {
    ...
    const { rerender } = render(<PageLayout /* exampleProp="initial" */ />);
    rerender(<PageLayout /* exampleProp="updated" */ />);
  ...
  it.skip('invokes callback props', async () => {
    ...
    const user = userEvent.setup();
    render(<PageLayout /* onAction={onAction} */ />);
